            ...
            <ThemedView className='flex-1 bg-white dark:bg-dark-bg'>
                <SafeAreaView className='flex-1'>
                    ...
                    <View className='flex-1 items-center justify-center'>
                        ...
                        <ThemedText className='text-gray-500 dark:text-gray-400 mt-4'>Loading ticket...</ThemedText>
                    </View>
                </SafeAreaView>
            </ThemedView>
        )
        ...
        <ThemedView className='flex-1 bg-white dark:bg-dark-bg'>
            <SafeAreaView className='flex-1'>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 20, paddingBottom: 120 }}>
                    {/* Image */}
                    <View className='w-full h-48 rounded-3xl overflow-hidden mb-6 bg-gray-100 dark:bg-dark-card'>
                        <Image
                    ...
                    <View className='gap-6 mb-8'>
                        ...
                        {ticket.checkedIn && (
                            <View className='bg-green-50 dark:bg-green-900/30 p-4 rounded-xl'>
                    ...
                    {/* Barcode Placeholder */}
                    <View className='h-24 bg-white dark:bg-dark-bg border border-gray-200 dark:border-gray-700 rounded-xl mb-8 items-center justify-center overflow-hidden'>
                    ...
                    <View className='gap-3 mb-6'>
                        <View className='flex-row justify-between'>
                            ...
                            <Currency className='text-slate-800 dark:text-gray-300 font-medium'>{ticket.ticket.price.toFixed(2)}</Currency>
                        </View>

                        <View className='h-[1px] bg-gray-100 dark:bg-dark-card my-1' />
